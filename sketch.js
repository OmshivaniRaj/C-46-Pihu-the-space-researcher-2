...
function preload(){
  ...
  shooter_shooting = loadImage("assets/Astro3.jpeg")

  zombieImg = loadImage("assets/ASTEROID.jpeg")

  bgImg = loadImage("assets/BG 3.jpeg")
...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
   ...
   //create book 
   MysteryBook=createSprite(displayWidth-400,displayHeight-800,50,50);
   MysteryBook.shapeColor= ("yellow");
